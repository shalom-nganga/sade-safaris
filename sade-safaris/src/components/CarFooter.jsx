      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
              ...
              <div>
                ...
                <div style={{
                  ...
                  letterSpacing: '2px',
                }}>CAR HIRE & RENTALS</div>
              </div>
            </div>
            <p style={{
              fontSize: '13px', color: 'rgba(255,255,255,.45)',
              lineHeight: 1.85, maxWidth: '280px', marginBottom: '20px',
            }}>
              Nairobi's trusted car hire service. Quality vehicles,
              professional drivers, and unbeatable prices across Kenya.
            </p>
          ...
          {[
            ...
            <div key={title}>
              <h4 style={{
                ...
                borderBottom: '2px solid #1a56db', display: 'inline-block',
              }}>
                {title}
              </h4>
              {items.map(item => (
                <div key={item} style={{
                  fontSize: '13px', color: 'rgba(255,255,255,.45)',
                  marginBottom: '9px', cursor: 'pointer', transition: 'all .2s',
                }}
                  onMouseEnter={e => {
        ...
        <div style={{
          ...
          <div style={{ fontSize: '12px', color: 'rgba(255,255,255,.25)' }}>
            © 2026 Sade Drive — A Sade Safaris Company. All rights reserved.
          </div>
          <div style={{ display: 'flex', gap: '20px' }}>
            {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map(l => (
              <span key={l} style={{
                fontSize: '12px', color: 'rgba(255,255,255,.25)',
