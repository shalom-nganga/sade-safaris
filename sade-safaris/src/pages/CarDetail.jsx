...
function CarDetail() {
    ...
    return (
      <div style={{ fontFamily: "'Nunito Sans', sans-serif" }}>
        ...
        <div style={{ textAlign: 'center', padding: '120px 5%' }}>
          ...
          <h2 style={{ fontFamily: "'Oswald', sans-serif", fontSize: '32px', marginBottom: '12px' }}>
            VEHICLE NOT FOUND
          </h2>
          <button
  ...
  const handleSubmit = () => {
    if (!name || !email || !phone || !pickupDate || !returnDate || !pickupLocation) return;
    setSubmitted(true);
  };
    ...
    <div style={{ fontFamily: "'Nunito Sans', sans-serif", background: '#f0f4ff' }}>
      ...
      <section style={{ position: 'relative', height: '55vh', minHeight: '380px', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(to top, rgba(15,23,42,.85) 0%, rgba(15,23,42,.2) 60%)',
        }} />
        ...
        <button
          onClick={() => navigate('/car-hire/fleet')}
          style={{
            position: 'absolute', top: '24px', left: '5%', zIndex: 3,
            background: 'rgba(255,255,255,.12)', backdropFilter: 'blur(8px)',
            border: '1px solid rgba(255,255,255,.25)', color: 'white',
            padding: '9px 18px', borderRadius: '6px', cursor: 'pointer',
            fontSize: '13px', fontWeight: 700, fontFamily: 'inherit', transition: 'all .2s',
          }}
        ...
        {/* Title */}
        <div style={{
          position: 'absolute', bottom: '32px', left: '5%', right: '5%', zIndex: 2,
        }}>
          <div style={{
        ...
        {/* Thumbnail strip */}
        <div style={{
          position: 'absolute', bottom: '32px', right: '5%', zIndex: 3,
          ...
          {vehicle.images.map((img, i) => (
            <div
              ...
              style={{
                ...
                cursor: 'pointer',
                border: activeImg === i ? '3px solid #60a5fa' : '3px solid transparent',
                transition: 'border .2s', flexShrink: 0,
              }}
            >
      ...
      <section style={{ padding: '48px 5%' }}>
        <div style={{
          ...
          display: 'grid', gridTemplateColumns: '1fr 400px', gap: '32px',
        }}>
          ...
          <div>
            ...
            <div style={{
              ...
              {tabs.map(tab => (
                <button
                  ...
                  style={{
                    padding: '16px 24px', fontSize: '12px', fontWeight: 800,
            ...
            {activeTab === 'overview' && (
              <div style={{ background: 'white', borderRadius: '0 0 8px 8px', padding: '32px', boxShadow: '0 2px 12px rgba(0,0,0,.06)' }}>
                ...
                <p style={{ fontSize: '15px', color: '#475569', lineHeight: 1.85, marginBottom: '32px' }}>
                  {vehicle.desc}
                </p>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
                  {Object.entries(vehicle.specs).map(([key, val]) => (
                    <div key={key} style={{
                      ...
                      <div style={{
                        fontSize: '11px', fontWeight: 800, color: '#1a56db',
            ...
            {activeTab === 'specs' && (
              <div style={{ background: 'white', borderRadius: '0 0 8px 8px', padding: '32px', boxShadow: '0 2px 12px rgba(0,0,0,.06)' }}>
                <h2 style={{
                  fontFamily: "'Oswald', sans-serif", fontSize: '24px',
                  fontWeight: 700, textTransform: 'uppercase',
                  marginBottom: '24px', color: '#1a1a2e',
                }}>
                  FULL SPECIFICATIONS
                </h2>
                {[
                  ...
                  ['Power Output', vehicle.specs.power],
                  ['Ground Clearance', vehicle.specs.groundClearance],
                  ['Fuel Range', vehicle.specs.range],
                  ['Drive System', vehicle.features.includes('4WD') ? '4WD / All Wheel Drive' : '2WD'],
                  ['Air Conditioning', 'Yes — Climate Control'],
                  ['Insurance', 'Comprehensive cover included'],
                  ['GPS Navigation', vehicle.features.includes('GPS') ? 'Included' : 'Optional'],
                ].map(([key, val]) => (
                  <div key={key} style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '32px' }}>
                  {vehicle.features.map(f => (
                    <div key={f} style={{
                      ...
                      padding: '14px 16px', background: '#f0f4ff', borderRadius: '8px',
                      border: '1px solid #e0e7ff',
                    }}>
                      <span style={{
                        width: '24px', height: '24px', borderRadius: '50%',
                        background: '#1a56db', color: 'white', display: 'flex',
            ...
            {activeTab === 'reviews' && (
              <div style={{ background: 'white', borderRadius: '0 0 8px 8px', padding: '32px', boxShadow: '0 2px 12px rgba(0,0,0,.06)' }}>
                <div style={{
                  ...
                  marginBottom: '32px', background: '#f0f4ff',
                  padding: '24px', borderRadius: '8px', border: '1px solid #e0e7ff',
                }}>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{
                      fontFamily: "'Oswald', sans-serif", fontSize: '64px',
                      fontWeight: 700, color: '#1a56db', lineHeight: 1,
                    }}>
                      4.9
                    </div>
                    <div style={{ display: 'flex', gap: '4px', justifyContent: 'center', margin: '8px 0' }}>
                      {[1,2,3,4,5].map(s => (
                        <span key={s} style={{ color: '#f5c518', fontSize: '20px' }}>★</span>
                      ))}
                    </div>
                    ...
                    {[5,4,3,2,1].map(star => (
                      <div key={star} style={{
                        ...
                        <div style={{
                          ...
                          <div style={{
                            height: '100%', background: '#1a56db', borderRadius: '4px',
                            width: star === 5 ? '80%' : star === 4 ? '15%' : '5%',
                          }} />
                        </div>
                        <span style={{ fontSize: '12px', color: '#94a3b8', width: '30px' }}>
                ...
                {[
                  { name: 'Michael Otieno', role: '🇰🇪 Nairobi', text: 'Excellent vehicle, very clean and well maintained. The GPS was super helpful navigating through traffic. Will definitely hire again!', rating: 5 },
                  { name: 'Emma Richardson', role: '🇬🇧 United Kingdom', text: 'Used this for our safari drive to Masai Mara. Powerful, comfortable, and handled rough roads like a beast. Couldn\'t have asked for more.', rating: 5 },
                  { name: 'Carlos Mendez', role: '🇪🇸 Spain', text: 'Great value for money. The team at Fast Lane were very professional and the handover process was quick and easy.', rating: 5 },
                ].map(r => (
                  <div key={r.name} style={{
                    background: '#f8fafc', borderRadius: '8px', padding: '20px',
                    marginBottom: '14px', borderLeft: '4px solid #1a56db',
                  }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '2px' }}>
                        {[1,2,3,4,5].map(s => (
                          <span key={s} style={{ color: '#f5c518', fontSize: '14px' }}>★</span>
                        ))}
                      </div>
                    </div>
                    <p style={{ fontSize: '13px', color: '#475569', lineHeight: 1.7, fontStyle: 'italic' }}>
                      "{r.text}"
                    </p>
                  </div>
                ))}
          ...
          <div style={{ position: 'sticky', top: '90px', alignSelf: 'flex-start' }}>
            <div style={{
              ...
              boxShadow: '0 8px 32px rgba(26,86,219,.12)',
              ...
              <div style={{
                ...
                <div style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255,255,255,.6)', letterSpacing: '1px', marginBottom: '4px' }}>
                  DAILY RATE FROM
                </div>
                <div style={{
                  fontFamily: "'Oswald', sans-serif", fontSize: '44px',
                ...
                {!vehicle.available && (
                  <div style={{
                    marginTop: '12px', background: '#e74c3c', color: 'white',
                    fontSize: '12px', fontWeight: 800, padding: '6px 16px',
              ...
              {submitted ? (
                <div style={{ padding: '40px 24px', textAlign: 'center' }}>
                  ...
                  <h3 style={{
                    ...
                    fontWeight: 700, color: '#1a56db', marginBottom: '10px',
                    textTransform: 'uppercase',
                  }}>
                    BOOKING REQUEST SENT!
                  </h3>
                  <p style={{ fontSize: '13px', color: '#64748b', lineHeight: 1.7, marginBottom: '20px' }}>
                    Thank you <strong>{name}</strong>! We'll confirm your <strong>{vehicle.name}</strong> booking
                    at <strong>{email}</strong> within 2 hours.
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    style={{
                      background: 'transparent', color: '#1a56db',
                      border: '2px solid #1a56db', padding: '10px 24px',
                ...
                <div style={{ padding: '24px' }}>
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      {[
                        { val: false, label: '🚗 Self Drive' },
                        { val: true, label: '👨‍✈️ With Driver' },
                      ].map(opt => (
                        <button
                          key={String(opt.val)}
                    ...
                    {withDriver && (
                      <p style={{
                        ...
                        background: '#eff6ff', padding: '6px 10px', borderRadius: '4px',
                      }}>
                        Driver fee: <strong style={{ color: '#1a56db' }}>KES 2,500/day</strong> added below
                      </p>
                    )}
                  </div>
                  ...
                  {[
                    ...
                    { label: '✉️ Email', value: email, setter: setEmail, placeholder: 'your@email.com', type: 'email' },
                    { label: '📞 Phone', value: phone, setter: setPhone, placeholder: '+254 700 000 000', type: 'tel' },
                  ].map(f => (
                    <div key={f.label} style={{ marginBottom: '12px' }}>
                      ...
                      <input
                        ...
                        style={{
                          width: '100%', border: '2px solid #e2e8f0', borderRadius: '6px',
                    ...
                    {[
                      ...
                      <div key={f.label}>
                        ...
                        <input
                          ...
                          style={{
                            width: '100%', border: '2px solid #e2e8f0', borderRadius: '6px',
                            padding: '10px 10px', fontSize: '12px', fontFamily: 'inherit',
                  ...
                  <div style={{ marginBottom: '12px' }}>
                    ...
                    <select
                      ...
                      style={{
                        width: '100%', border: '2px solid #e2e8f0', borderRadius: '6px',
                        padding: '10px 12px', fontSize: '13px', fontFamily: 'inherit',
                        outline: 'none', cursor: 'pointer', background: '#f8fafc', color: '#333',
                      }}
                      onFocus={e => e.target.style.borderColor = '#1a56db'}
                      onBlur={e => e.target.style.borderColor = '#e2e8f0'}
                    >
                  ...
                  {days && (
                    <div style={{
                      ...
                      {withDriver && (
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px', marginBottom: '6px' }}>
                          <span style={{ color: '#64748b' }}>Driver fee × {days} days</span>
                          <span style={{ fontWeight: 700, color: '#1a1a2e' }}>KES {(2500 * days).toLocaleString()}</span>
                        </div>
                      )}
                      <div style={{
                        display: 'flex', justifyContent: 'space-between',
                        fontSize: '16px', fontWeight: 800, paddingTop: '8px',
                        borderTop: '1px solid #e0e7ff', marginTop: '6px',
                      }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: vehicle.available
                        ? 'linear-gradient(135deg, #1a56db, #0e3fa5)'
                        : '#e2e8f0',
                      color: vehicle.available ? 'white' : '#aaa',
                      border: 'none', borderRadius: '8px',
                      cursor: vehicle.available ? 'pointer' : 'not-allowed',
                      fontFamily: 'inherit', letterSpacing: '.5px',
                      transition: 'all .25s',
                      boxShadow: vehicle.available ? '0 4px 16px rgba(26,86,219,.4)' : 'none',
                    }}
                    onMouseEnter={e => { if (vehicle.available) e.currentTarget.style.transform = 'translateY(-1px)'; }}
                    onMouseLeave={e => { if (vehicle.available) e.currentTarget.style.transform = 'translateY(0)'; }}
                  >
                  ...
                  <p style={{
                    ...
                    🔒 No payment now. We confirm within 2 hours. Free cancellation 24hrs before pickup.
                  </p>
                </div>
              )}
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '13px', fontWeight: 700, color: 'rgba(255,255,255,.7)', marginBottom: '6px' }}>
              ...
              <div style={{ fontSize: '11px', color: 'rgba(255,255,255,.4)', marginTop: '4px' }}>
                Available Mon–Sat, 7am–8pm
              </div>
            </div>
          </div>
        </div>
