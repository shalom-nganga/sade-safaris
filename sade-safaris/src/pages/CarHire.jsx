...
function CarHire() {
  ...
  let filtered = vehicles.filter(v => {
    ...
    const matchSeat =
      activeSeat === 'Any' ||
      (activeSeat === '1-5' && v.seats <= 5) ||
      (activeSeat === '6-9' && v.seats >= 6 && v.seats <= 9) ||
      (activeSeat === '10+' && v.seats >= 10);
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
            ...
            <div style={{ paddingBottom: '60px' }}>
              <div style={{
                ...
                <span style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255,255,255,.8)', letterSpacing: '1.5px', textTransform: 'uppercase' }}>
              ...
              <p style={{
                ...
                lineHeight: 1.8, marginBottom: '36px', maxWidth: '460px',
              }}>
                From rugged safari 4x4s to sleek executive saloons — hire the
                perfect vehicle for any journey across Kenya. With or without a driver.
              </p>
            ...
            <div style={{ paddingBottom: '40px' }}>
              <div style={{
                ...
                padding: '32px', boxShadow: '0 24px 64px rgba(0,0,0,.3)',
              }}>
                <h3 style={{
                  fontFamily: "'Oswald', sans-serif", fontSize: '22px',
                  fontWeight: 700, textTransform: 'uppercase',
                  marginBottom: '6px', color: '#1a1a2e',
                }}>
                  CHECK AVAILABILITY
                </h3>
                <p style={{ fontSize: '13px', color: '#888', marginBottom: '24px' }}>
                  Find your perfect vehicle in seconds
                </p>
                    ...
                    {[
                      ...
                      <button
                        ...
                        style={{
                          ...
                          background: withDriver === opt.val ? '#1a56db' : 'white',
                          color: withDriver === opt.val ? 'white' : '#555',
                ...
                <button style={{
                  ...
                  transition: 'all .25s', boxShadow: '0 4px 16px rgba(26,86,219,.4)',
                }}
        ...
        <div style={{
          ...
          {[
            ...
            <div key={title} style={{
              ...
              padding: '16px', borderRadius: '8px', transition: 'background .2s',
            }}
      ...
      <section style={{ padding: '64px 5%' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
              ...
              {types.map(t => (
                <button
                  ...
                  style={{
                    ...
                    transition: 'all .2s',
                    background: activeType === t ? '#1a56db' : 'white',
                    color: activeType === t ? 'white' : '#555',
                    border: activeType === t ? '2px solid #1a56db' : '2px solid #e2e8f0',
                    boxShadow: activeType === t ? '0 4px 12px rgba(26,86,219,.3)' : 'none',
                  }}
                >
                  {t}
                </button>
          ...
          <div style={{
            ...
            boxShadow: '0 2px 12px rgba(0,0,0,.05)', marginBottom: '32px',
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                {seats.map(s => (
                  <button key={s} onClick={() => setActiveSeat(s)} style={{
                    ...
                    background: activeSeat === s ? '#1a56db' : 'white',
                    color: activeSeat === s ? 'white' : '#555',
                    borderColor: activeSeat === s ? '#1a56db' : '#e2e8f0',
                  }}>{s}</button>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '6px' }}>
                {transmissions.map(t => (
                  <button key={t} onClick={() => setActiveTransmission(t)} style={{
                    padding: '6px 14px', fontSize: '12px', fontWeight: 700,
                    borderRadius: '4px', cursor: 'pointer', fontFamily: 'inherit',
                    transition: 'all .2s', border: '1.5px solid',
                    background: activeTransmission === t ? '#1a56db' : 'white',
                    color: activeTransmission === t ? 'white' : '#555',
                    borderColor: activeTransmission === t ? '#1a56db' : '#e2e8f0',
                  }}>{t}</button>
                ))}
              </div>
            </div>
            ...
            <div style={{ flex: 1, minWidth: '200px' }}>
              <div style={{ fontSize: '10px', fontWeight: 800, color: '#1a56db', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '8px' }}>
                MAX: KES {maxPrice.toLocaleString()}/DAY
              </div>
              <input
            ...
            <div>
              ...
              <select
                ...
                style={{
                  border: '1.5px solid #e2e8f0', borderRadius: '4px', padding: '7px 12px',
              ...
              {filtered.map(vehicle => (
                <div
                  ...
                  style={{
                    ...
                    opacity: vehicle.available ? 1 : 0.65,
                ...
                >
                  ...
                  <div style={{ height: '200px', overflow: 'hidden', position: 'relative' }}>
                    ...
                    {!vehicle.available && (
                      <div style={{
                        ...
                        <span style={{
                          background: '#e74c3c', color: 'white', fontSize: '14px',
                          fontWeight: 800, padding: '8px 20px', borderRadius: '4px',
                          letterSpacing: '1px',
                        }}>
                  ...
                  <div style={{ padding: '20px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', marginBottom: '16px' }}>
                      {vehicle.features.slice(0, 4).map(f => (
                        <span key={f} style={{
                          ...
                          background: '#f0f4ff', padding: '3px 8px', borderRadius: '20px',
                    ...
                    <div style={{
                      ...
                      borderTop: '1px solid #f1f5f9', marginBottom: '14px',
                    }}>
                      <div>
                        <span style={{ fontSize: '10px', color: '#aaa', display: 'block' }}>FROM</span>
                        <span style={{
                          fontFamily: "'Oswald', sans-serif", fontSize: '26px',
                          fontWeight: 700, color: '#1a56db',
                        }}>
                          KES {(withDriver ? vehicle.pricePerDay + 2500 : vehicle.pricePerDay).toLocaleString()}
                        </span>
                      ...
                      {pickupDate && returnDate && (
                        <div style={{ textAlign: 'right' }}>
                          ...
                          <span style={{
                            ...
                            fontWeight: 700, color: '#0e3fa5',
                          }}>
                            KES {((withDriver ? vehicle.pricePerDay + 2500 : vehicle.pricePerDay) * days).toLocaleString()}
                          </span>
                        </div>
                      )}
                    </div>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      <button
                        ...
                        style={{
                          ...
                          background: vehicle.available ? 'linear-gradient(135deg, #1a56db, #0e3fa5)' : '#e2e8f0',
                          color: vehicle.available ? 'white' : '#aaa',
                          border: 'none', borderRadius: '6px',
                          cursor: vehicle.available ? 'pointer' : 'not-allowed',
                          fontFamily: 'inherit', letterSpacing: '.5px',
                          boxShadow: vehicle.available ? '0 4px 12px rgba(26,86,219,.3)' : 'none',
                          transition: 'all .2s',
                        }}
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: '2px solid #1a56db', borderRadius: '6px',
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          ...
          <h2 style={{
            ...
            LET US FIND YOUR<br />
            <span style={{ color: '#60a5fa' }}>PERFECT VEHICLE</span>
          </h2>
          <p style={{
            fontSize: '16px', color: 'rgba(255,255,255,.7)',
            lineHeight: 1.75, marginBottom: '36px',
          }}>
            Our team is available 7 days a week to help you choose the right
            vehicle and arrange pickups, drivers, and custom itineraries.
          </p>
