    ...
    <div>
          ...
          {tour.images.map((img, i) => (
            <div
              ...
              style={{
                ...
                cursor: 'pointer', border: activeImg === i ? '3px solid #f5c518' : '3px solid transparent',
      ...
      <section style={{ padding: '48px 5%', background: '#f9f9f7' }}>
        <div style={{
          ...
          display: 'grid', gridTemplateColumns: '1fr 380px', gap: '32px',
        }}>
          ...
          <div>
            ...
            <div style={{
              ...
              {tabs.map(tab => (
                <button
                  ...
                  style={{
                    padding: '14px 24px', fontSize: '12px', fontWeight: 800,
                    letterSpacing: '1px', textTransform: 'uppercase',
                    background: 'transparent', border: 'none', cursor: 'pointer',
                    fontFamily: 'inherit', transition: 'all .2s',
                    color: activeTab === tab ? '#4a9c2f' : '#888',
                    borderBottom: activeTab === tab ? '3px solid #4a9c2f' : '3px solid transparent',
                    marginBottom: '-2px',
                  }}
                >
                  {tab}
            ...
            {activeTab === 'overview' && (
              <div>
                ...
                <p style={{
                  fontSize: '15px', color: '#555', lineHeight: 1.85,
                  marginBottom: '32px',
                }}>
                  {tour.description}
                </p>
                  ...
                  <div key={i} style={{
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        background: '#4a9c2f', color: 'white', display: 'flex',
                    ...
                    <div style={{
                      ...
                      flex: 1, boxShadow: '0 2px 8px rgba(0,0,0,.05)',
                      marginBottom: i < tour.itinerary.length - 1 ? '0' : '0',
                    }}>
                      <div style={{
                      ...
                      <h4 style={{
                        ...
                        fontWeight: 600, marginBottom: '8px', color: '#1a1a1a',
                      }}>
                        {item.title}
                      </h4>
                ...
                <div>
                  ...
                  {tour.excludes.map(item => (
                    <div key={item} style={{
                      ...
                      <span style={{ color: '#e74c3c', fontWeight: 800, flexShrink: 0 }}>✗</span>
                      {item}
                    </div>
                  ))}
                </div>
            ...
            {activeTab === 'reviews' && (
              <div>
                <div style={{
                  ...
                  marginBottom: '32px', background: 'white', padding: '28px',
                  borderRadius: '8px', boxShadow: '0 2px 12px rgba(0,0,0,.06)',
                }}>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{
                      fontFamily: "'Oswald', sans-serif", fontSize: '64px',
                      fontWeight: 700, color: '#4a9c2f', lineHeight: 1,
                    }}>
                      {tour.rating}
                    </div>
                  ...
                  <div style={{ flex: 1 }}>
                    {[5,4,3,2,1].map(star => (
                      <div key={star} style={{
                        ...
                        <span style={{ fontSize: '12px', color: '#888', width: '40px' }}>{star} ★</span>
                        <div style={{
                          flex: 1, height: '8px', background: '#eee', borderRadius: '4px', overflow: 'hidden',
                        }}>
                          <div style={{
                            height: '100%', background: '#4a9c2f', borderRadius: '4px',
                            width: star === 5 ? '75%' : star === 4 ? '18%' : star === 3 ? '5%' : '1%',
                          }} />
                        </div>
                        <span style={{ fontSize: '12px', color: '#888', width: '30px' }}>
                          {star === 5 ? '75%' : star === 4 ? '18%' : star === 3 ? '5%' : '1%'}
                        </span>
                      </div>
                    ))}
                  </div>
                ...
                {[
                  ...
                  <div key={r.name} style={{
                    ...
                    boxShadow: '0 2px 8px rgba(0,0,0,.05)', marginBottom: '16px',
                    borderLeft: '4px solid #4a9c2f',
                  }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '2px' }}>
                        {[1,2,3,4,5].map(s => (
                          <span key={s} style={{ color: '#f5c518', fontSize: '16px' }}>★</span>
                        ))}
                      </div>
                    </div>
                    <p style={{ fontSize: '14px', color: '#555', lineHeight: 1.7, fontStyle: 'italic' }}>
                      "{r.text}"
                    </p>
                  </div>
                ))}
          ...
          <div style={{ position: 'sticky', top: '90px', alignSelf: 'flex-start' }}>
            <div style={{
              ...
              {/* Price header */}
              <div style={{
                background: '#2d6a1a', padding: '24px',
                textAlign: 'center',
              }}>
                <div style={{ fontSize: '12px', fontWeight: 700, color: 'rgba(255,255,255,.7)', letterSpacing: '1px', marginBottom: '4px' }}>
                  FROM
                </div>
                <div style={{
                ...
                <div style={{ fontSize: '12px', color: 'rgba(255,255,255,.7)', marginTop: '4px' }}>
                  per person
                </div>
              </div>
              ...
              {submitted ? (
                <div style={{ padding: '40px 24px', textAlign: 'center' }}>
                  ...
                  <h3 style={{
                    ...
                    fontWeight: 700, color: '#4a9c2f', marginBottom: '10px',
                  }}>
                    BOOKING REQUEST SENT!
                  </h3>
                  <p style={{ fontSize: '14px', color: '#666', lineHeight: 1.7 }}>
                    Thank you {name}! Our team will contact you at {email} within 24 hours to confirm your booking.
                  </p>
                  <button
                    onClick={() => setSubmitted(false)}
                    style={{
                      marginTop: '20px', background: 'transparent', color: '#4a9c2f',
                      border: '2px solid #4a9c2f', padding: '10px 24px',
                ...
                <div style={{ padding: '24px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                      <button
                        ...
                        style={{
                          ...
                          color: '#4a9c2f', fontSize: '20px', cursor: 'pointer',
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          fontWeight: 800, fontFamily: 'inherit', transition: 'all .2s',
                        }}
                        onMouseEnter={e => {
                      ...
                      <span style={{ fontSize: '20px', fontWeight: 800, flex: 1, textAlign: 'center' }}>
                  ...
                  {/* Total */}
                  <div style={{
                    background: '#eaf5e3', borderRadius: '6px', padding: '14px 16px',
                    ...
                    <span style={{
                      ...
                      KES {(tour.price * guests).toLocaleString()}
                    </span>
                  </div>
