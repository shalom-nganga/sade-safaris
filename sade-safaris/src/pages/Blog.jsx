    ...
    <div>
      ...
      <section style={{ position: 'relative', padding: '100px 5%', overflow: 'hidden' }}>
        <div style={{
          ...
          backgroundSize: 'cover', backgroundPosition: 'center', filter: 'brightness(.3)',
        }} />
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          {featured && (
            <div onMouseEnter={() => setHovered('featured')} onMouseLeave={() => setHovered(null)}
              style={{
                display: 'grid', gridTemplateColumns: '1fr 1fr', background: 'white', borderRadius: '8px', overflow: 'hidden',
                boxShadow: hovered === 'featured' ? '0 20px 48px rgba(0,0,0,.14)' : '0 4px 20px rgba(0,0,0,.08)',
                marginBottom: '56px', cursor: 'pointer',
                transform: hovered === 'featured' ? 'translateY(-4px)' : 'translateY(0)', transition: 'all .3s ease',
              }}
            >
              <div style={{ height: '420px', overflow: 'hidden', position: 'relative' }}>
                ...
                <div style={{ position: 'absolute', top: '20px', left: '20px', background: '#f5c518', color: '#1a1a1a', fontSize: '11px', fontWeight: 800, letterSpacing: '1px', padding: '5px 14px', borderRadius: '3px', textTransform: 'uppercase' }}>
                  ⭐ FEATURED POST
                </div>
              </div>
              <div style={{ padding: '48px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                <h2 style={{ fontFamily: "'Oswald', sans-serif", fontSize: '32px', fontWeight: 700, color: '#1a1a1a', lineHeight: 1.2, marginBottom: '16px' }}>{featured.title}</h2>
                ...
                <div style={{ display: 'flex', gap: '8px', marginBottom: '28px', flexWrap: 'wrap' }}>
                  {(featured.tags || []).map(tag => (
                    <span key={tag} style={{ fontSize: '11px', fontWeight: 700, color: '#4a9c2f', background: '#eaf5e3', padding: '4px 10px', borderRadius: '3px' }}>#{tag}</span>
                  ))}
                </div>
                ...
                >
                  ...
                  <div style={{ padding: '24px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', marginBottom: '16px' }}>
                      {(post.tags || []).map(tag => (
                        <span key={tag} style={{ fontSize: '10px', fontWeight: 700, color: '#4a9c2f', background: '#eaf5e3', padding: '3px 8px', borderRadius: '3px' }}>#{tag}</span>
                      ))}
                    </div>
