...
const experiences = [
  {
    ...
    badge: 'Bucket List',
    desc: 'Float silently above the Masai Mara at sunrise, watching the Great Migration from above while sipping champagne. The most unforgettable 3 hours of your life.',
    highlights: ['Sunrise flight over the Mara', 'Champagne bush breakfast', 'Certificate of flight', 'Professional pilot and crew'],
  },
  {
    id: 2,
    ...
    desc: 'Step inside an authentic Maasai boma and experience daily life, traditional dances, beadwork, and the warm hospitality of Kenya\'s most iconic tribe.',
    highlights: ['Traditional warrior dances', 'Beadwork and craft demonstration', 'Home visit with a Maasai family', 'Learn about Maasai traditions'],
  },
  {
    id: 3,
    ...
    desc: 'Leave the vehicle behind and explore the African bush on foot with an armed ranger. Track animals by their prints, discover medicinal plants, and feel truly wild.',
    highlights: ['Armed ranger escort', 'Animal tracking on foot', 'Medicinal plant tour', 'Bird identification'],
  },
  {
    id: 4,
    title: 'Sundowner Game Drive',
    category: 'Wildlife',
    duration: '3 Hours',
    price: 9500,
    difficulty: 'Easy',
    ...
    badge: 'Most Booked',
    desc: 'The golden hour is magic in the bush. Join our evening game drive as the savanna turns amber, predators emerge to hunt, and drinks are served under the African sky.',
    highlights: ['Evening wildlife activity', 'Sundowner drinks on the savanna', 'Night drive option', 'Expert guide'],
  },
  {
    id: 5,
    title: 'Ocean Dhow Sunset Cruise',
    category: 'Coastal',
    duration: '2 Hours',
    price: 7500,
    difficulty: 'Easy',
    ...
    badge: 'Romantic',
    desc: 'Sail the Indian Ocean on a traditional wooden dhow as the sun dips below the horizon. Fresh seafood, cold drinks, and the sound of waves — pure Diani magic.',
    highlights: ['Traditional dhow sailing', 'Fresh seafood platter', 'Sunset views over the Indian Ocean', 'Snorkeling stop available'],
  },
  {
    id: 6,
    ...
    desc: 'The African night belongs to different creatures. With a spotlight and an expert guide, discover bush babies, leopards, civets, and the nocturnal world most never see.',
    highlights: ['Spotlight wildlife search', 'Nocturnal animal sightings', 'Star gazing stop', 'Expert night guide'],
  },
  {
    id: 7,
    ...
    badge: 'Photography',
    desc: 'Travel with a professional wildlife photographer and learn how to capture stunning safari images. From composition to lighting — leave with photos you\'ll treasure forever.',
    highlights: ['Professional photographer guide', 'Camera settings workshop', 'Golden hour shoots', 'Small group for maximum access'],
  },
  {
    id: 8,
    ...
    badge: 'Conservation',
    desc: 'Walk alongside conservancy rangers on a guided rhino trek at Ol Pejeta. Get closer to these magnificent endangered animals than any vehicle can, while supporting their protection.',
    highlights: ['Guided rhino tracking on foot', 'Conservancy ranger briefing', 'Conservation certificate', 'Direct contribution to rhino protection'],
  },
  {
    id: 9,
    title: 'Mount Kenya Scenic Hike',
    category: 'Adventure',
    duration: 'Full Day',
    price: 14000,
    ...
    badge: 'Adventure',
    desc: 'A single-day hike through the spectacular lower slopes of Mount Kenya, passing through rainforest, moorland, and alpine zones with jaw-dropping views of the peaks above.',
    highlights: ['Rainforest and moorland zones', 'Alpine plant species', 'Stunning peak views', 'Experienced mountain guide'],
  },
];
  ...
  return (
    <div>
      ...
      <section style={{ position: 'relative', padding: '100px 5%', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <h1 style={{
            ...
            UNFORGETTABLE<br />
            <span style={{ color: '#f5c518' }}>SAFARI EXPERIENCES</span>
          </h1>
          <p style={{
            fontSize: '17px', color: 'rgba(255,255,255,.85)',
            maxWidth: '560px', lineHeight: 1.75,
          }}>
            Go deeper than a standard safari. Our curated experiences let you
            connect with Africa's wildlife, culture, and landscapes in ways
            most travellers never get to.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: '#2d6a1a', padding: '28px 5%' }}>
        <div style={{
          ...
          {[
            ...
            ['⭐ 4.9', 'Average Rating'],
            ['500+', 'Happy Adventurers'],
            ['🌿', 'Eco-Certified'],
          ].map(([n, l]) => (
            <div key={l} style={{ textAlign: 'center' }}>
              <div style={{
                fontFamily: "'Oswald', sans-serif", fontSize: '32px',
                fontWeight: 700, color: '#f5c518', lineHeight: 1,
              }}>
                {n}
              </div>
              <div style={{
                fontSize: '11px', fontWeight: 700, color: 'rgba(255,255,255,.7)',
            ...
            {filtered.map(exp => (
              <div
                ...
                style={{
                  ...
                  boxShadow: hovered === exp.id ? '0 20px 48px rgba(0,0,0,.14)' : '0 2px 12px rgba(0,0,0,.07)',
                  transform: hovered === exp.id ? 'translateY(-8px)' : 'translateY(0)',
              ...
              >
                ...
                <div style={{ height: '220px', overflow: 'hidden', position: 'relative' }}>
                  <img
                    ...
                    style={{
                      ...
                      transform: hovered === exp.id ? 'scale(1.06)' : 'scale(1)',
                ...
                <div style={{ padding: '22px' }}>
                  ...
                  <p style={{
                    ...
                    marginBottom: '14px',
                    maxHeight: expanded === exp.id ? 'none' : '60px',
                    overflow: 'hidden',
                  }}>
                    {exp.desc}
                  </p>
                  ...
                  <button
                    ...
                    style={{
                      background: 'none', border: 'none', color: '#4a9c2f',
                      fontSize: '12px', fontWeight: 800, cursor: 'pointer',
                      padding: 0, fontFamily: 'inherit', marginBottom: '16px',
                      letterSpacing: '.5px',
                    }}
                  >
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      background: '#f5f5f5', padding: '4px 10px', borderRadius: '3px',
                    }}>
                      🏃 {exp.difficulty}
                    </span>
                  </div>
      ...
      <section style={{ position: 'relative', padding: '100px 5%', overflow: 'hidden' }}>
        <div style={{
          position: 'absolute', inset: 0,
          backgroundImage: 'url(https://images.unsplash.com/photo-1535941339077-2dd1c7963098?w=1800&q=80)',
          backgroundSize: 'cover', backgroundPosition: 'center',
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            <span style={{ color: '#f5c518' }}>PERFECT ITINERARY</span>
          </h2>
          <p style={{
            fontSize: '16px', color: 'rgba(255,255,255,.8)',
            lineHeight: 1.7, marginBottom: '40px',
          }}>
            Mix and match experiences with any of our tours to create a completely
            bespoke East African adventure tailored just for you.
          </p>
