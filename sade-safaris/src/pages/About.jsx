...
const team = [
  {
    ...
    bio: 'Born and raised in Nairobi, Samuel has spent over 20 years guiding safaris across East Africa. His deep knowledge of wildlife behaviour and Kenyan culture makes every journey extraordinary.',
  ...
  },
  {
    ...
    bio: 'Amina ensures every Sade Safaris booking runs seamlessly from first enquiry to final departure. Her attention to detail and warm personality keep our guests coming back.',
  ...
  },
  {
    ...
    bio: 'David specialises in bird watching and big cat tracking. With a degree in Wildlife Management, he brings scientific depth to every game drive across the Mara and Tsavo.',
    img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80',
    exp: '15 Years',
  },
  {
    name: 'Grace Muthoni',
    role: 'Travel & Booking Consultant',
    bio: 'Grace is the first voice you hear when you reach out to us. She crafts personalised itineraries that match every traveller\'s budget, interests, and dream safari vision.',
  ...
  return (
    <div>
      ...
      <section style={{
        ...
        <div style={{
          position: 'absolute', inset: 0,
          background: 'linear-gradient(135deg, rgba(45,106,26,.7), transparent)',
        }} />
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <h1 style={{
            ...
            BORN FROM A<br />
            <span style={{ color: '#f5c518' }}>LOVE OF AFRICA</span>
          </h1>
          <p style={{
            fontSize: '17px', color: 'rgba(255,255,255,.85)',
            maxWidth: '560px', lineHeight: 1.75,
          }}>
            For over 15 years, Sade Safaris has been connecting passionate travelers
            with the raw, untamed beauty of East Africa. We are not just a tour company
            — we are storytellers, conservationists, and proud Kenyans.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '80px 5%', background: 'white' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '72px', alignItems: 'center' }}>
          <div>
            <p style={{
            ...
            <h2 style={{
              fontFamily: "'Oswald', sans-serif", fontSize: '40px',
              fontWeight: 700, textTransform: 'uppercase',
              lineHeight: 1.1, marginBottom: '24px', color: '#1a1a1a',
            }}>
              MORE THAN JUST<br />
              <span style={{ color: '#4a9c2f' }}>A SAFARI COMPANY</span>
            </h2>
            <p style={{ fontSize: '15px', color: '#555', lineHeight: 1.85, marginBottom: '20px' }}>
              Sade Safaris was founded in 2009 by Samuel Kariuki, a Nairobi-born wildlife
              enthusiast who believed that every traveller deserved to experience Kenya's
              magic the way locals do — authentically, responsibly, and unforgettably.
            </p>
            <p style={{ fontSize: '15px', color: '#555', lineHeight: 1.85, marginBottom: '20px' }}>
              What started as one man, one vehicle, and an unshakeable passion has grown
              into a team of 25 dedicated professionals, operating across Kenya, Tanzania,
              Uganda, and Rwanda. But our heart has never changed — every safari we run
              is personal, purposeful, and deeply rooted in a love for this land.
            </p>
            <p style={{ fontSize: '15px', color: '#555', lineHeight: 1.85, marginBottom: '36px' }}>
              We are proud members of the Kenya Tourism Federation, certified by the
              Kenya Eco-Tourism Board, and winners of the East Africa Travel Award for
              Best Safari Operator in 2023 and 2024.
            </p>
            <button
              onClick={() => navigate('/tours')}
              style={{
                background: '#4a9c2f', color: 'white', border: 'none',
                padding: '15px 32px', fontSize: '14px', fontWeight: 800,
                cursor: 'pointer', borderRadius: '4px', fontFamily: 'inherit',
                letterSpacing: '.5px', transition: 'all .25s',
              }}
              onMouseEnter={e => {
                e.currentTarget.style.background = '#2d6a1a';
          ...
          <div style={{ position: 'relative', height: '520px' }}>
            <img
              ...
              style={{
                ...
                width: '65%', height: '65%', objectFit: 'cover',
                borderRadius: '8px', boxShadow: '0 8px 32px rgba(0,0,0,.15)',
              }}
            />
            <img
              src="https://images.unsplash.com/photo-1551009175-8a68da93d5f9?w=600&q=80"
              alt="Elephants"
              style={{
            ...
            />
            <div style={{
              position: 'absolute', bottom: '18%', left: '-10px',
              background: '#f5c518', padding: '20px 24px',
              borderRadius: '6px', textAlign: 'center',
              boxShadow: '0 8px 24px rgba(0,0,0,.15)',
            }}>
              <div style={{
                fontFamily: "'Oswald', sans-serif", fontSize: '42px',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px' }}>
            {values.map(v => (
              <div key={v.title} style={{
                ...
                borderTop: '4px solid #4a9c2f', boxShadow: '0 2px 16px rgba(0,0,0,.05)',
                transition: 'all .3s',
              }}
                onMouseEnter={e => {
                  e.currentTarget.style.transform = 'translateY(-6px)';
                  e.currentTarget.style.boxShadow = '0 16px 40px rgba(0,0,0,.1)';
                  e.currentTarget.style.borderTopColor = '#f5c518';
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.transform = 'translateY(0)';
                  e.currentTarget.style.boxShadow = '0 2px 16px rgba(0,0,0,.05)';
                  e.currentTarget.style.borderTopColor = '#4a9c2f';
                }}
              >
                <div style={{
                  fontSize: '36px', marginBottom: '16px',
                  width: '60px', height: '60px', background: '#eaf5e3',
            ...
            {milestones.map((m, i) => (
              <div key={m.year} style={{
                ...
                <div style={{
                  ...
                  background: '#4a9c2f', border: '3px solid white',
                  boxShadow: '0 0 0 3px #4a9c2f', zIndex: 2,
                }} />

                <div style={{
                  width: '44%',
                  background: '#f9f9f7', borderRadius: '8px', padding: '24px 28px',
                  boxShadow: '0 2px 12px rgba(0,0,0,.06)',
                  borderLeft: i % 2 === 0 ? '4px solid #4a9c2f' : 'none',
                  borderRight: i % 2 !== 0 ? '4px solid #4a9c2f' : 'none',
                  textAlign: i % 2 === 0 ? 'left' : 'right',
                }}>
                  <div style={{
                    fontFamily: "'Oswald', sans-serif", fontSize: '28px',
                    fontWeight: 700, color: '#f5c518', marginBottom: '4px',
                  }}>
                    {m.year}
                  </div>
                  <h4 style={{
            ...
            {team.map(member => (
              <div
                ...
                style={{
                  ...
                  boxShadow: hoveredMember === member.name
                    ? '0 20px 48px rgba(0,0,0,.14)'
                    : '0 2px 12px rgba(0,0,0,.07)',
                  transform: hoveredMember === member.name ? 'translateY(-8px)' : 'translateY(0)',
                ...
                <div style={{ height: '240px', overflow: 'hidden', position: 'relative' }}>
                  <img
                    ...
                    style={{
                      ...
                      transform: hoveredMember === member.name ? 'scale(1.06)' : 'scale(1)',
      ...
      <section style={{ position: 'relative', padding: '100px 5%', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            <span style={{ color: '#f5c518' }}>PERFECT SAFARI</span>
          </h2>
